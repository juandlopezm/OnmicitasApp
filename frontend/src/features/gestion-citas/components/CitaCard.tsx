...
import { CalendarDays, Clock, MapPin, Stethoscope, CalendarClock, XCircle, AlertTriangle, User } from 'lucide-react'
      ...
      <CardContent className="flex flex-col gap-2">
        {cita.pacienteNombre && (
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="font-medium text-primary">{cita.pacienteNombre}</span>
          </div>
        )}
