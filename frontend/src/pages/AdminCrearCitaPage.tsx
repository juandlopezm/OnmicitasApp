...
export function AdminCrearCitaPage() {
  ...
  useEffect(() => {
    if (estado.paso === 4) getSedes().then(setSedes)
  }, [estado.paso])
            ...
            <>
              ...
              <CardContent className="space-y-5">
                <div className="flex flex-col gap-1.5">
                  ...
                  <Select
                    value={estado.fecha}
                    onChange={e => setEstado(prev => ({ ...prev, fecha: e.target.value, hora: '' }))}
                    ...
                    {horarios.length === 0 ? (
                      ...
                      <div className="horario-grid">
                        {horarios.map(h => (
                          <button
                            key={h.id}
                            onClick={() => setEstado(prev => ({ ...prev, hora: h.hora, horarioId: h.id }))}
                            className={cn(
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <Select
                    value={estado.sedeId}
                    onChange={e => setEstado(prev => ({ ...prev, sedeId: e.target.value }))}
